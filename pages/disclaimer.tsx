...
const Disclaimer: NextPage<Props> = ({}) => {
  return (
    <>
      <NextSeo
        title="Read Our Website's Legal Disclaimer | Gossipgeeks"
        description="Read our website's legal disclaimer before using any information or services provided on Gossipgeeks. Our disclaimer outlines the terms and conditions of using our website and its content. By accessing and using our website, you agree to our disclaimer."
      ...
      <div className="container mx-auto text-center space-y-4 px-2">
        ...
        <div className="lg:w-5/6 mx-auto space-y-4 text-xl opacity-70 py-10">
          ...
          <p>
            ...
            are not under the control of GossipGeeks. We have no control over
