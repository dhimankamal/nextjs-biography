...
const PrivacyPolicy: NextPage<Props> = ({}) => {
  return (
    <>
      <NextSeo
        title="Privacy Policy - Learn How We Protect Your Personal Data | Gossipgeeks"
        description="At Gossipgeeks, we take your privacy seriously. Our Privacy Policy outlines how we collect, use, and protect your personal information when you use our website. We are committed to safeguarding your data and ensuring its confidentiality. Learn more about our privacy practices and your rights by reading our Privacy Policy."
      ...
      <div className="container mx-auto text-center space-y-4 px-2">
        ...
        <div className="lg:w-5/6 mx-auto space-y-4 text-xl opacity-70 py-10">
          ...
          <p>
            ...
            to our sites visitors based upon their visit to GossipGeeks and
          ...
          <p>
            ...
            certain practices. GossipGeeks privacy policy does not apply to, and
